...
const posts = [
  {
    id: 1,
    title: "3D Printing",
    url: "/blog/3d-printing", // updated URL
    excerpt:
      "3D Printing, also known as Additive Manufacturing, is a process of creating three-dimensional objects by building them layer by layer using a digital model. It is a revolutionary technology that enables creation using materials like plastics, metals, ceramics, and even living tissue.",
  },
  {
    id: 2,
    title: "Beginning of ND Automatronics",
    url: "/blog/Beginning-nda", // updated URL
    excerpt:
      "In September 2020, Mr Dinesh Krishna T. & Mr Hari Vignesh A. began the journey of building an FDM 3D printer. After collecting components and experimenting, the first functional printer, “AGNII.1,” was completed in December 2020, marking the start of ND Automatronics.",
  },
];
...
const June2023 = () => {
  return (
     <div className="blog-page-wrapper">
      <Helmet>
  <title>June 2023 Archives | Blog</title>
</Helmet>

    <div className="main-container">
      <h1 className="page-heading">June 2023</h1>
